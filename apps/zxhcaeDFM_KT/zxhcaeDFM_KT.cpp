...
chResultPath="F:/Coronary_0/ZXHJDQCAEDMP/DFMKT" ;
chAtlasCAFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image01_meancenterline_v0.vtk" ;
...
// get end point
	...
	{			
		...
		nItrNum =iMinPathModelCrct->DFM_KT(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz;vessel segment point selection condition
