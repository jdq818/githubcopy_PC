...
// get end point
	...
	{			
		...
		nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaFM_D_LR(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MaxVisePntNUM);//Decrease the weigth of direction and intensity
