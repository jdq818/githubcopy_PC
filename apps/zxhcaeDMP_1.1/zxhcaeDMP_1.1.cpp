...
//***MapModelfrom training data***//
 ...
 //   string strFileNameRaw = string(argv[1]);
	...
	string strFileNameRaw =  "F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset03/vessel3/Resmol_image01.nii";
	string strFileNameVsls = "F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset03/vessel3/Remoeb_image01_vesselness.nii";
	...
	char *chModelMapCAFileName = "F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image03_meancenterline_v3.vtk";
	char *chResultPath = "F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResults/mod03_to_unseen01_results/meanimg03v3model";
    ...
    char *chRCAFileName = "F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image03_meancenterline_v0.vtk";
	char *chLADFileName = "F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image03_meancenterline_v1.vtk";
	char *chREFRFileName = "F:/Coronary_0/Coronary_Niessen/ProcessByLL/training/dataset01/rightostium_world.txt";
	char *chREFLFileName = "F:/Coronary_0/Coronary_Niessen/ProcessByLL/training/dataset01/leftostium_world.txt";
	char *chAtlsMeanStdDevFileName = "F:/Coronary_0/meanstd/atlas03_mean_std.txt";
	char *chUnseenMeanStdDevFileName = "F:/Coronary_0/meanstd/atlas03_to_atlas01_mean_std.txt";  
   char *chMolPointsIntensityFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_intensity/image03_03mline_v3_inten.txt";
...
*/
	...
	vector< miiCNode<double, float> > vREFRPoints,vREFLPoints;
	ReadPointTxt(chREFRFileName, vREFRPoints);
	...
	nStartPoint[0] = vLADPoints[0].x;
	nStartPoint[1] = vLADPoints[0].y;
	nStartPoint[2] = vLADPoints[0].z;
   // get the estimated start point of reference,vessel1,2,3
	nREFStartPoint[0] =vREFLPoints[0].x;
	nREFStartPoint[1] =vREFLPoints[0].y;
	nREFStartPoint[2] =vREFLPoints[0].z;
