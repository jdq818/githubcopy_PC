...

{
	...
	strFileNameHrd=new string[7];
	strFileNameHrd[0]=string(argv[1]);//"F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod00_to_unseen07_new_results/meanimg00v0model";
	strFileNameHrd[1]=string(argv[2]);//"F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod01_to_unseen07_new_results/meanimg01v0model";
	strFileNameHrd[2]=string(argv[3]);//"F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod02_to_unseen07_new_results/meanimg02v0model";
	strFileNameHrd[3]=string(argv[4]);//"F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod03_to_unseen07_new_results/meanimg03v0model";
	strFileNameHrd[4]=string(argv[5]);//"F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod04_to_unseen07_new_results/meanimg04v0model";
	strFileNameHrd[5]=string(argv[6]);//"F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod05_to_unseen07_new_results/meanimg05v0model";
	strFileNameHrd[6]=string(argv[7]);//"F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod06_to_unseen07_new_results/meanimg06v0model";
	char *REFRFileNameHrd =argv[8];//"F:/Coronary_0/Coronary_Niessen/ProcessByLL/training/dataset00/vessel0/point";
	char *chResultPath =argv[9];//"F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/unseen00_results/vessel0";
	//for release** 

		//**for debug
	/*string *strFileNameHrd;
	strFileNameHrd=new string[7];
	strFileNameHrd[0]="F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod01_to_unseen00_results/meanimg01v0model";
	strFileNameHrd[1]="F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod02_to_unseen00_results/meanimg02v0model";
	strFileNameHrd[2]="F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod03_to_unseen00_results/meanimg03v0model";
	strFileNameHrd[3]="F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod04_to_unseen00_results/meanimg04v0model";
	strFileNameHrd[4]="F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod05_to_unseen00_results/meanimg05v0model";
	strFileNameHrd[5]="F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod06_to_unseen00_results/meanimg06v0model";
	strFileNameHrd[6]="F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/mod07_to_unseen00_results/meanimg07v0model";
	char *REFRFileNameHrd ="F:/Coronary_0/Coronary_Niessen/ProcessByLL/training/dataset00/vessel0/point";
	char *chResultPath ="F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResultsN/unseen00_results/vessel0";*/
	...
	// save max-path
	char chTemp1[25];
	_itoa_s(ModelFileNUM3, chTemp1, 10);
	char chTemp2[25];
	_itoa_s(MCLineMinNUM3, chTemp2, 10);
	
	int nFileLen = strlen(chResultPath) + strlen("/MCLineF.vtk")+1 ;
	char *chFileName1 = (char*)malloc(nFileLen);
	strcpy(chFileName1, chResultPath);
	strcat(chFileName1, "/MCLineF.vtk");
	WriteVtk(vPathPoints, chFileName1);
	free(chFileName1);

	char *chFileName2;
	chFileName2= (char*)malloc(nFileLen);
	strcpy(chFileName2, chResultPath);
	strcat(chFileName2, "/MCLineF.txt");
	WriteTxt(vPathPoints, chFileName2);
	free(chFileName2);
