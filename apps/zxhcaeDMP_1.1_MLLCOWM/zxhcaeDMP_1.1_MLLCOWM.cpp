...
if( argc < 11 )
	{
		...
		std::cerr << "zxhcaeDMP_1.1_MLL	imageRaw (.nii)  vesselness	(.nii)	atlas_vesselx	results	atlas_vessel	\
				detected-ostial atlas_mean	unseen_mean	ModelPointsIntensity	segment_num" << std::endl;
		return -1;
	}
...
string strFileNameVsls="F:/Coronary_0/Coronary_Niessen/CoronaryCMBImg25/CMB_image00_v0_vesselness.nii.gz";
char *chModelMapCAFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image06_meancenterline_v0.vtk";
char *chResultPath="F:/Coronary_0/trainningdataZXHCAEDMP/HighResoResults_CMB25/unseen00_ADE/vessel0";
char *chAtlasCAFileName ="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image06_meancenterline_v0.vtk";
char *chREFFileName ="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset00/rightostium_world.txt";
char *chAtlsMeanStdDevFileName ="F:/Coronary_0/meanstd/atlas06_mean_std.txt";
char *chUnseenMeanStdDevFileName ="F:/Coronary_0/meanstd/atlas00_mean_std.txt";
char *chMolPointsIntensityFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_intensity/image06_06mline_v0_inten.txt";
string strFileNameLineMask="F:/Coronary_0/trainningdataZXHCAEDMP/LowResoResults_CMB/unseen00_resultsADE/vessel0/MCLine_Mask.nii.gz";
int nMaxSgmtNum =30;	*/	
...
//string strFileNameRaw ="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/testing/dataset13/image13.nii.gz";
//string strFileNameVsls="F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLungFromBLToH/higvslsFromL13_v0_vesselness.nii.gz";//"F:/Coronary_0/Coronary_Niessen/CoronaryCMBImg/CMB_image13_v0_vesselness2.nii.gz";
//char *chModelMapCAFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image01_meancenterline_v0.vtk";
//char *chResultPath="F:/Coronary_0/testingdataZXHCAEDMP/HighResoResults/unseen13/vessel0";
//char *chAtlasCAFileName ="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image01_meancenterline_v0.vtk";
//char *chREFFileName ="F:/Coronary_0/Exp6_detect_ostia/Ostia0007To0831/Ostia0007To0831/dataset13_Meanostium_right.txt";
//char *chAtlsMeanStdDevFileName ="F:/Coronary_0/meanstd/atlas01_mean_std.txt";
//char *chUnseenMeanStdDevFileName ="F:/Coronary_0/meanstd/atlas13_mean_std.txt";
//char *chMolPointsIntensityFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_intensity/image01_01mline_v0_inten.txt";
//string strFileNameLineMask="F:/Coronary_0/testingdataZXHCAEDMP/LowResoResults/unseen13_results/vessel0/MCLine_SMO_Mask.nii.gz";
//int nMaxSgmtNum =30;
...
// get end point
	...
	int nET = GetTime();
	int nMaxItrNum = 1200000;
	int nMaxSumItrNum=60000000;
	int nSaveItrNum=200;
	int nItrNum=0;
	int nItrNumSum=0;
	...
	{			
		...
		nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCwithMaskMLL_D(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,2000,sLineMaskData);
		//nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCwithMaskMLL_DeaF_D(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,2000,sLineMaskData);
		//nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCwithMaskMLL_DeaF(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,2000,sLineMaskData);
		...
		if (nItrNum < nMaxItrNum && nItrNum > 0&&nItrNumSum<nMaxSumItrNum)
		{
			...
			else
			{
				...
				ofstream PosiFile;
				int nLen = strlen(chResultPath) + strlen("/Posi") +strlen(".txt")+1;
