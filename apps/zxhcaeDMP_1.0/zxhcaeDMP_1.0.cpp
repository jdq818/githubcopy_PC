...
//int zxhcaeDMP_main(int argc, char *argv[])//Use Resolution Mask to extraction
int main(int argc, char *argv[])//Use Resolution Mask to extraction
{
 ...
 //   string strFileNameRaw = string(argv[1]);
	...
	char *chModelMapCAFileName = "F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset02/vessel0/Simu_reference/SetintensiyByOnePoint/Simulation2.vtk";//simu-model points(JDQ)
	char *chResultPath = "F:/Coronary_0/miiMinPathModelApp_results/mod02Simu_to_unseen02_results_physnoimgres/ori_vessel0/SimuasModel/Simu2";
	...
	char *chMolPointsIntensityFileName="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset02/vessel0/Simu_reference/SetintensiyByOnePoint/Simuintensity2.txt";              
	int nMaxSgmtNum = 19;
...
// get end point
	...
	// set the model
	iMinPathModelCrct->SetModelPoints(vModelPoints, nStartPoint);//copy the model points to m_vmodelpoints including start point;calculate model curve length;
	...
	{			
		...
		nItrNum = iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointC(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,2000);
...
//	//string strFileNameVsls = "F:/Coronary_0/MultiResolution_results/DataMaskOutLung/WithWindoingVesselness200/SetOriIntensity/Remoeb_image02_vesselness.nii";
//	//string strFileNameRaw =  "F:/Coronary_0/MultiResolution_results/DataMaskOutLung/WithWindoingVesselness200/SetOriIntensity/Resmol_image02.nii";
//	string strFileNameLineMask="F:/Coronary_0/miiMinPathModelApp_results/mod02Simu_to_unseen02_results_physnoimgres/ori_vessel0/SimuasModel/Simu0/MCLine_Mask.nii";
//	
//	
...
//	char *chModelMapCAFileName = "F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset02/vessel0/Simu_reference/SetintensiyByOnePoint/Simulation0.vtk";//simu-model points(JDQ)
//	//char *chModelMapCAFileName = "F:/Coronary_0/miiMinPathModelApp_results/mod02Simu_to_unseen02_results_physnoimgres/ori_vessel0/SimuasModel/Simu0/MCLine.vtk";//resolu-model points(JDQ)
//	
//    //char *chResultPath = "F:/Coronary_0/miiMinPathModelApp_results/mod02Simu_to_unseen02_results_physnoimgres/ori_vessel0/testing";
//	char *chResultPath = "F:/Coronary_0/miiMinPathModelApp_results/mod02Simu_to_unseen02_results_physnoimgres/ori_vessel0/SimuasModel/Simu0";
//
...
//	//char *chMolPointsIntensityFileName="F:/Coronary_0/miiMinPathModelApp_results/mod02Simu_to_unseen02_results_physnoimgres/ori_vessel0/SimuasModel/Simu0/MCLine_intensity.txt";
...
//			// find the minimal path by using back-propagation
//			cout << "Finding minimal path..." << endl;
//			if (iMinPathModelCrct->FindMinPathWithintensiy(nStartPoint,sWinImg ,2000))//if (iMinPathModelCrct->FindMinPath(nStartPoint, 2000))
//			{
//				bRunResult = true;
//			}
//			else
