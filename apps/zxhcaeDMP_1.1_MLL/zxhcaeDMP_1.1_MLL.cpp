...
// get end point
	...
	{			
		...
		nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaF(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,2000);//Decrease the weigth of direction and intensity
		nItrNumSum=nItrNumSum+nItrNum;
