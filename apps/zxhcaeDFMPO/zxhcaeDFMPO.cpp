...
//strFileNameRaw="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/mol_image/mol_new_image04.nii.gz" ;
//strFileNameVsls="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/moeb_vesselness/moeb_image_04_new_vesselness.nii.gz" ;
//chModelMapCAFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image00_meancenterline_v0.vtk" ;
//chResultPath="F:/Coronary_0/ZXHJDQCAEDMP/DHResDFM_VVS_VSPSC6_BPD_O/mod00_to_unseen04_results/meanimg00v0model" ;
...
//nMaxSgmtNum=30 ;
//strLorH="DH";
//strFileNameVslsx="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/moeb_u1_vesselness/mol_image04_new_vesselness_x1.nii.gz" ;
//strFileNameVslsy="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/moeb_u1_vesselness/mol_image04_new_vesselness_y1.nii.gz" ;
//strFileNameVslsz="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/moeb_u1_vesselness/mol_image04_new_vesselness_z1.nii.gz";

//strFileNameRaw="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/mol_image/mol_new_image04.nii.gz" ;
//strFileNameVsls="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/moeb_vesselness/moeb_image_04_new_vesselness.nii.gz" ;
//chModelMapCAFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image06_meancenterline_v1.vtk" ;
//chResultPath="F:/Coronary_0/ZXHJDQCAEDMP/DHResDFM_VVS_VSPSC6_BPD_O/mod06_to_unseen04_results/meanimg06v1model" ;
//chAtlasCAFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image06_meancenterline_v1.vtk" ;
//chREFFileName="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset04/leftostium_world.txt" ;
//chAtlsMeanStdDevFileName="F:/Coronary_0/meanstd/atlas06_mean_std.txt" ;
//chUnseenMeanStdDevFileName="F:/Coronary_0/meanstd/atlas04_mean_std.txt" ;
//chMolPointsIntensityFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_intensity/image06_06mline_v1_inten.txt" ;
//nMaxSgmtNum=30 ;
//strLorH="DH";
//strFileNameVslsx="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/moeb_u1_vesselness/mol_image04_new_vesselness_x1.nii.gz" ;
//strFileNameVslsy="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/moeb_u1_vesselness/mol_image04_new_vesselness_y1.nii.gz" ;
...
// get end point
	...
	{			
		...
		nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaFM_DN_VVSel_VSPSC_BPD_O(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz;vessel segment point selection condition
		...
		if (nItrNum >0)
		{
			if (iMinPathModelCrct->FindMinPathWithintensiyLL_O(imgReadRaw.GetImageInfo(),nStartPoint,sWinImg ,2000))//if (iMinPathModelCrct->FindMinPath(nStartPoint, 2000))
			{

				iMinPathModelCrct->UpdateVSPSet();//update vessel segment point set;
				bRunResult = true;
			}
			else
			{
		...
		cout << "Saving "<<i+1<<"-th Vessel Segment point..." << endl;
	...
	//back tracking to the start point from vssel segment point one by one
	if(iMinPathModelCrct->UpdateCurveSet(imgReadRaw.GetImageInfo(),nStartPoint,chResultPath))//update curve set;
	{
		
		if(iMinPathModelCrct->Outputvtktxt(chResultPath))
		{
		WriteFileMC << "The curve set updates successfully!" << endl;
		}
	}
	else

		WriteFileMC << "The curve set updates unsuccessfully!" << endl;
