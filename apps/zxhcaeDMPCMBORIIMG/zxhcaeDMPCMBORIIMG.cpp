...
int main(int argc, char *argv[])//without intensity nomalization
{
	...
	zxhImageDataT<short> imgReadVsls,imgResoUpRespVsls,imgReadMask,imgCMBVsls,imgCMBVsls1,imgCMBVsls2;//Change by JDQ
	...
	if( zxh::OpenImage( &imgReadMask, strResoMAPToHighMask ) == false )
	{
